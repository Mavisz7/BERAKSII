...
const fallbackQuestions: QuizQuestion[] = [
  ...
  { id: 'q6', question: 'Apa kepanjangan dari BERAKSI dalam pencegahan hipertensi?', options: ['Batasi, Enyahkan, Rajin, Atur, Kelola, Stop, Ikuti', 'Beli, Enak, Riang, Aman, Kuat, Sehat, Indah', 'Bersama, Elok, Rajin, Aman, Kuat, Sehat, Indah', 'Bantu, Enyahkan, Rawat, Atur, Kelola, Stop, Ikuti'], correct_index: 0, explanation: 'BERAKSI: Batasi garam dan lemak, Enyahkan asap rokok, Rajin aktivitas fisik, Atur pola makan sehat, Kelola stres, Stop alkohol, Ikuti pemeriksaan tekanan darah rutin.', category: 'BERAKSI', sort_order: 6, created_at: new Date().toISOString() },
