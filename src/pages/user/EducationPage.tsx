...
const fallbackArticles: Article[] = [
  ...
  { id: '6', title: 'Prinsip CERDIK', category: 'Pola Hidup', excerpt: 'Pola hidup sehat CERDIK.', content: 'CERDIK: Cek kesehatan rutin, Enyahkan asap rokok, Rajin aktivitas fisik, Diet sehat & seimbang, Istirahat cukup, Kendalikan stres. Prinsip ini adalah kunci pengendalian hipertensi.', image_url: '', icon: 'Sparkles', featured: true, created_at: '' },
];
